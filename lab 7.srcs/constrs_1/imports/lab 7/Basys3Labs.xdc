...
## LEDs
set_property PACKAGE_PIN U16 [get_ports {S_LED0}]
	set_property IOSTANDARD LVCMOS33 [get_ports {S_LED0}]
set_property PACKAGE_PIN E19 [get_ports {S_LED1}]
...
set_property PACKAGE_PIN V19 [get_ports {S_LED3}]
